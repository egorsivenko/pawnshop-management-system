...
CREATE TABLE items (
    ...
    FOREIGN KEY(item_category) REFERENCES item_categories(item_category_id) ON DELETE SET NULL
);
...
CREATE TABLE pawnbroker_specialization (
    ...
    FOREIGN KEY (pawnbroker_id) REFERENCES pawnbrokers(pawnbroker_id) ON DELETE CASCADE,
    FOREIGN KEY (specialization) REFERENCES item_categories(item_category_id) ON DELETE CASCADE
);
...
CREATE TABLE pawn_transactions (
    ...
    FOREIGN KEY(pawnbroker_id) REFERENCES pawnbrokers(pawnbroker_id) ON DELETE SET NULL
);
...
CREATE TABLE repayments (
    ...
    FOREIGN KEY(transaction_id) REFERENCES pawn_transactions(transaction_id) ON DELETE CASCADE,
    FOREIGN KEY(payment_method) REFERENCES payment_methods(payment_method_id) ON DELETE SET NULL
);
