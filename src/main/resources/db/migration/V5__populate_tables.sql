...
VALUES  ('Kari', 'Metz', '105-441-2932', 'Kari41@hotmail.com'),
        ...
        ('Roger', 'Bayer', '635-969-8879', 'Alfonso.OHara92@hotmail.com'),
...
VALUES  ('Rolando', 'Sipes', '1999-04-29', '520-609-7095', 'Rolando39@yahoo.com', '3800 Fisher Circle'),
        ...
        ('Marty', 'Streich', '2003-06-11', '695-164-6754', 'Sherry1@yahoo.com', '263 Domingo Mill'),
...
INSERT INTO pawn_transactions (customer_id, item_id, pawnbroker_id, pawn_amount, pawn_date)
VALUES  (1, 7, 1, '353.00', DATE_SUB(CURDATE(), INTERVAL 3 MONTH)),
        (5, 3, 6, '417.00', DATE_SUB(CURDATE(), INTERVAL 2 MONTH));

INSERT INTO payment_methods (payment_method_name)
VALUES  ('Cash'), ('Credit Card'), ('Bank transfer'), ('PayPal'), ('Contactless NFC payment');

INSERT INTO repayments (transaction_id, payment_method)
VALUES (1, 2), (4, 1), (5, 3), (9, 2);
